...
setGeneric("truncateTxome", signature=c("txdb", "maxTxLength", "txEnd"),
           function(txdb, maxTxLength=500, txEnd="3prime", ...) standardGeneric("truncateTxome")
)
...
setMethod("truncateTxome", "TxDb", function(txdb,
  ...
  clipped <- bplapply(grlExons, .clipTranscript, maxTxLength=maxTxLength, txEnd=txEnd,
                      BPPARAM=BPPARAM)
